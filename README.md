...
- Clone Repository ini Diterminal kesayangan anda `git clone https://github.com/farishhz/voting-osis`
...
- Clone this Repository in your favorite terminal `git clone https://github.com/farishhz/voting-osis`
