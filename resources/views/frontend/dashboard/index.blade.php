    ...
    <div id="app">
        <header id="header" class="header d-flex align-items-center sticky-top">
            <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
                ...
                <a href="index.html" class="logo d-flex align-items-center">
                    ...
                    <h1 class="sitename"><span>{{ $web_setting?->web_title ?? 'VOTING OSIS' }}</span></h1>
                </a>
        ...
        <main class="main">
            ...
            <section id="pricing" class="pricing section">
                ...
                <template v-if="status == 'buka'">
                    ...
                    <div class="container section-title" data-aos="fade-up">
                        <h2>{{ $web_setting?->web_title ?? 'VOTING OSIS' }}</h2>
        ...
        <template v-if="status == 'buka'">
            <footer id="footer" class="footer light-background">
                <div class="container">
                    <div class="credits">
                        VOTING OSIS by <a href="https://github.com/farishhz" target="_blank">farishhz</a> Template By <a href="https://bootstrapmade.com/">BootstrapMade</a>
                    </div>
                </div>
            </footer>
        </template>
